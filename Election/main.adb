...
begin
   ...
   Put_Line("Printing Regional votes for Election A");
   print(A);
   Put_Line("Printing Final votes for Election A after Removing 10 votes from Budapest");
   print(A, False);
   ...
   Put_Line(Calculate_Regional_Percentage_Of_Candidate(A, Budapest, Rasul)'Image);

   Put_Line("For checking purposes all percentages of individuals should add up to 100 -> ");
