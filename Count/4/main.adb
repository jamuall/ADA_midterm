...
procedure Main is
   ...
   Y: String_Vector(0..12) := "okuusPokaberi";
...
begin
   ...
   Put_Line("Compare 4 and 5: " & Boolean'Image(Count_Integer.Compare(4, 5)));
   Put_Line("A < B : " & Boolean'Image(Count_Integer."<"(A, B)));
   ...
   Put_Line("Compare A and J: " & Boolean'Image(Count_Character.Compare('A', 'J')));
   Put_Line("X < Y : " & Boolean'Image(Count_Character."<"(X, Y)));
